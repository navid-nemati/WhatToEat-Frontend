        ...
        <div className="pt-30 pb-10">
            <Container>
                <div className="max-w-4xl mx-auto">
                    ...
                    {/* هدر صفحه */}
                    <div className="mb-8">
                        <h1 className="text-2xl font-bold text-slate-800">مدیریت دسته‌بندی‌ها</h1>
                        <p className="text-slate-500 mt-1">دسته‌بندی‌های سایت را مدیریت و ایجاد کنید.</p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                        <div className="mb-4 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <div className="w-1 h-6 bg-emerald-500 rounded-full"></div>
                                <h2 className="text-lg font-bold text-slate-800">لیست دسته‌بندی‌ها</h2>
                            </div>

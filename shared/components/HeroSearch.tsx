    ...
    return (
        <div className="w-full max-w-100 md:w-100 flex flex-nowrap items-center gap-3">
            ...
            <Link
                ...
                className="group flex items-center gap-2 left-round 
                    bg-amber-400 px-6 py-3 text-md md:text-lg font-medium 
                    text-emerald-950 shadow-lg shadow-amber-400/30 transition-all 
                    duration-200 ring-amber-200 hover:ring-2 hover:shadow-xl 
                    hover:shadow-amber-400/40 hover:scale-105 active:scale-95 
                    text-shadow-sm text-nowrap">

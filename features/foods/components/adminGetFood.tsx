            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {data?.map(food => (
                    <div
                        ...
                        key={food.id}
                        className="group w-full p-5 rounded-xl bg-white border border-gray-200 shadow-sm hover:shadow-lg hover:border-emerald-300 transition-all duration-200 flex flex-col gap-2 justify-between animate-item-pop"
                    >
                        <Link
